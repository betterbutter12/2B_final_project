...
for i in range(1, 4):
    for j in range(i + 1, 5):
        ...
        plt.savefig(f'public_graphs/s{i}_s{j}.png')
plt.close('all') 
...
# Ensure 15 clusters (post-process if needed)
n_clusters_required = 4 * 4 - 1 
...
output.to_csv('grading/public_submission.csv', index=False)
